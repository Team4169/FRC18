...
public class Lift extends Subsystem {
    ...
    public void moveLift(int speed) {
    		if (speed == 1) {
    			liftMotor.set(OI.getInstance().controller.getTriggerAxis(GenericHID.Hand.kRight));
    		} else if (speed == -1) {
    			liftMotor.set(OI.getInstance().controller.getTriggerAxis(GenericHID.Hand.kLeft));
    		} else {
    			liftMotor.set(0);
    		}
    }
